...
ax[0].plot([],[],label="$D_r=$%.0e"%Dr)
ax[0].plot([],[],label="$v_0=$%.0e"%v0)
...
fig.savefig("__bb-20250318-snapshot%d-%d-%d-%d-%d-%d.png"%(tau_snapshot,seed,e_L,e_Dr,e_v0,e_Dth))
