## ___bb-20250720-graph.py
## % time python ___bb-20250720-graph.py seed e_L e_Dr e_v0 e_Dth &
...
#data_parameter=np.array(pd.read_csv("_bb-20250708-data_parameter-%d-%d-%d-%d-%d.txt"%(seed,e_L,e_Dr,e_v0,e_Dth),header=None,sep=" ",engine="python"))
...
#data_graph=np.array(pd.read_csv("_bb-20250708-data_graph-%d-%d-%d-%d-%d.txt"%(seed,e_L,e_Dr,e_v0,e_Dth),header=None,sep=" ",engine="python"))
...
#data_diagram=np.array(pd.read_csv("_bb-20250708-data_diagram-%d-%d-%d-%d-%d.txt"%(seed,e_L,e_Dr,e_v0,e_Dth),header=None,sep=" ",engine="python"))
...
fig.savefig("__bb-20250720-graph_draft-%d-%d-%d-%d-%d.pdf"%(seed,e_L,e_Dr,e_v0,e_Dth))
